...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <form role="form" id="formPatient" class="form-horizontal" enctype="multipart/form-data">
              <div> <h2>FILL IN THE PATIENT DATA</h2> </div>
              ...
              <div class="form-group">
                <label for="symptoms" class="control-label col-sm-2">Symptoms</label>
                <div class="col-sm-10">
              ...
              <input type="submit" class="btn btn-style btn-add col-sm-offset-2" value="Add Patient Record">
            </form>
      </div>
      <div class="col-md-4">
